...
if (isset($_POST['PrCodeLst']) && ($_POST['PrCodeLst'] != $db->Row_Count($ressmytest)+1) && $_POST['PrCodeLst'] !="new" )
{
	//print 'fgfgfg';
	$PrCodeLst=$_POST['PrCodeLst'];
	//print $PrCodeLst;
    ...
    <td><table border="0" align="center">
	 ...
	 <tr>
	  ...
	  <tr>
       ...
       <th>:</th>
       <td><input type="text" name="txtyear" id="txtyear" size="30" value="<?php echo $bud_year;?>" /></td>
      </tr>
