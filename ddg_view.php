...
$id1=$br_no;
 ...
 $hod=$db->Exe_Qry("select DivisionCode from emp_details_tbl  WHERE EmpNo='$hodemp_no'");
	...
	$query =$db->Exe_Qry("SELECT * FROM bud_req_user WHERE br_no='$br_no'") ;
	...
	if (isset($_POST['butdel']))
{
	...
	$db->Exe_Qry("INSERT INTO `pr_deny`(`br_no`, `reason`) VALUES ('$id1',reason);");
  ...
  <table id="wrapped2" align="center" width="95%"  border="0" cellpadding="10" cellspacing="1">
   ...
   <tr>
    <td><table border="0"  align="center">
       ...
       <th>:</th>
       <td><input type="text" name="prno" id="prno"  value="<?php echo $br_no;?>" /></td>
      </tr>
	  <tr>
