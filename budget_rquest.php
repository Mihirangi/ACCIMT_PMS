...
<head>
    ...
    if (isset($_POST['btnAdd']))
    {
        ...
        if (true){
            ...
            $db->Exe_Qry("INSERT INTO pc_bud_req_user 
	(br_no,user,equ_detail,purpose, similar_equ,reason,value,target_month,req_date,bud_year,bud_code,item_name_qty) 
	VALUES ('$PrCodeLst','".$_SESSION['proclogin_un']."' ,'$equ_detail','$purpose','$similar_equ','$reason','$value','$target_month','$req_date','$bud_year','$bud_coden','$itemqty');");
