 ...
 ?>
    ...
    <td><table border="0"  align="center">
      ...
      <tr>
	   ...
	   <?php 
			...
			$pr_number =$db->Exe_Qry("SELECT b.id,b.approved,b.pr_no FROM bud_req_user b,division_tbl d,emp_details_tbl e where b.user=e.EmpNo and e.DivisionCode=d.DivisionCode and d.DivisionCode='$divhod' and (b.approved='N' || b.approved='')"); // where division='$'
	   ...
	   <?php 
			...
			$pr_number2 =$db->Exe_Qry("SELECT b.id,b.approved,b.pr_no FROM bud_req_user b,division_tbl d,emp_details_tbl e where b.user=e.EmpNo and e.DivisionCode=d.DivisionCode and d.DivisionCode='$divhod' and b.approved='Y'"); // where division='$'
			echo '<option value="app" >--Approved List--</option>';
			while ($row2 = mysql_fetch_array($pr_number2)) {
			echo "<option  value='$row2[id]'>$row2[pr_no]</option>";
			}
		?>
			<script language="javascript" type="text/javascript">
  ...
  <table width="1429"  cellpadding="5" cellspacing="3" id="wrapped">
   <tr>
    ...
    <?php
	$pr_number =$db->Exe_Qry("SELECT * FROM emp_details_tbl e, bud_req_user b,division_tbl d WHERE b.user=e.EmpNo and e.DivisionCode=d.DivisionCode and d.DivisionCode='$divhod' and b.recommend='' and b.approved='Y'"); 
