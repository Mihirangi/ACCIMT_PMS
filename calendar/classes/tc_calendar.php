...
class tc_calendar{
	...
	function writeScript(){
		...
		if($this->date_picker){
			echo("<div style=\"position: relative; z-index: $this->zindex; float: left;\" id=\"container_".$this->objname."\" onmouseout=\"javascript:focusCalendar('$this->objname');\" onmouseout=\"javascript:unFocusCalendar('$this->objname', $this->zindex);\">");
	...
	function writeCalendarContainer(){
		...
		$mover_str = " onmouseout=\"javascript:cancelHide('$this->objname');\"";
