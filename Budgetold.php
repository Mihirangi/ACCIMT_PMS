	...
	<script type="text/javascript">
		...
		function selectr(){
			...
			if(result == "new"){
				...
				if(ajaxRequest.readyState == 4){
				//alert (ajaxRequest.responseText);
					document.getElementById('txtdescription').value = ajaxRequest.responseText;
					document.getElementById('txtsdescription').value = ajaxRequest.responseText;
					document.getElementById('txtbudcode').value = ajaxRequest.responseText;
				}
				}
...
<div id="wrapp">
   ...
   <tr>
    <th>
	<table align="center">
		<tr><td>Budget No</td><td><div id = "selectbud" name = "selectbud"></div></td></tr>
		<tr><td>Budget Description</td><td><input type = "text" name = "txtdescription" id = "txtdescription"/></td></tr>
		<tr><td>Short Description</td><td><input type = "text" name = "txtdsdescription" id = "txtsdescription"/></td></tr>
		<tr><td>Budget Code</td><td><input type = "text" name = "txtbudcode" id = "txtbudcode"/></td></tr>
