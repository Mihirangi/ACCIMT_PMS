...
if (isset($_POST['btnAdd']))
{
	...
	if($file_no!= null && $pr_dtls_code != null && $task != null){
	$result=$db->Exe_Qry("INSERT INTO pr_dtls_tbl SET file_no='$file_no', pr_dtls_code ='$pr_dtls_code' , task ='$task';");
	mysql_query($query);
	$butOp=true;
...
document.getElementById("pr_dtls_code").value="<?php  echo $pr_dtls_code;?>";
  ...
  <br />
         ...
         <td class="tbrow" width="22%"><div align="center">
            <input name="btnR" type="submit" id="btnR" value="Add Remark" onClick="document.location..href ='AddRemarks.php?">
           </div></td>
          <td class="tbrow"  width="6%">&nbsp;</td>
         </tr>
