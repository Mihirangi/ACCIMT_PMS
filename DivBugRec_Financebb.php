...
<?php 
$sql="SELECT * FROM bud_req_hod WHERE  bud_year='$BudYerLst' and hod='$hod1' and approved='y'";	
...
<th width='100'> DG Approved Total Amount</th>
...
while($row = $db->Next_Record($result)) {  
    ...
    echo "<tr>";
	 echo '<td style="color:#000" bgcolor="#FFFFFF"`>' . $row['total_id'] . "</td>";	
    echo '<td style="color:#000" bgcolor="#FFFFFF"`>' . $row['bud_code'] . "</td>";	
	 echo '<td style="color:#000" bgcolor="#FFFFFF"`>' . $row['hod'] . "</td>";
    echo '<td style="color:#000" bgcolor="#FFFFFF"`>' . $row['total'] . "</td>";
	echo '<td style="color:#000" bgcolor="#FFFFFF"`>' . $row['appd_total'] . "</td>";
	echo '<td style="color:#000" bgcolor="#FFFFFF"`>' . $row['DG_appdtotal'] . "</td>";
