...
class FRMOperations
{
    ...
    public function HeaddernMenu($utype)
    {
            ...
            echo '<li><a href="budget.php" onClick="scrollpg()" target="datafrm">Budget Types</a></li>
			  <li><a href="pur_type.php" onClick="scrollpg()" target="datafrm">Purchase Types</a></li>
								   ...
								   <li>
			   						...
			   						<span class="dir">Supplier</span>
			  						
									<ul>
								   <li><a href="supplier_detail.php" onClick="scrollpg()" target="datafrm">Supplier Details</a></li>
								   <li><a href="supplier_item.php" onClick="scrollpg()" target="datafrm">Supplier Item</a></li>
								   <li><a href="add_item.php" onClick="scrollpg()" target="datafrm">Add Items</a></li>
								   </ul>
								   </li>
        ...
        echo '
			 ...
			 <li>
			  <center>
			   <span class="dir">BR & PR Process</span>
			  </center>
			  <ul>
			  <li>
			  <span class="dir">Request Budget</span>
			  <ul>
			  <li><a href="budget_rquest.php" onClick="scrollpg()" target="datafrm">Yearly Budget Request</a></li>
              ...
              <li><a href="spec_req.php" onClick="scrollpg()" target="datafrm">PR Specification Requirements</a></li>
			   			  
			  </ul>
			  
			  </li>
			  <li>
			   <span class="dir">Procurement Process</span>
			  <ul>
