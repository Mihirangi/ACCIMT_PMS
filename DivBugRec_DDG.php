...
while($myrow = $db->Next_Record($myresult)) 
{
	...
	$bud_code= $myrow["bud_code"];
		...
		$db->Exe_Qry("UPDATE pc_bud_req_hod  SET appd_DDG='Y', appd_total='$appAmount' WHERE  bud_year='$BudYerLst' and bud_code='$bud_code' and hod='$hod1'");
