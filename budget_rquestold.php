...
{
	$db->Exe_Qry("DELETE FROM bud_req_user  WHERE pr_no='$PrCodeLst' and approved <> 'y'");
    ...
    <td><table border="0" align="center">
      <tr>
       ...
       <td width="569"><?php 
		...
		//$ress = $db->Exe_Qry("SELECT pr_no FROM bud_req_user order by pr_no");// Where user='$_SESSION[proclogin_un]'
		$ress1 = $db->Exe_Qry("SELECT pr_no FROM bud_req_user Where user='$_SESSION[proclogin_un]' order by pr_no"); 
		//echo'<option value="'.(($db->Row_Count($ress1))+1).'"></option>';
	 ...
	 <tr>
	   ...
	   <th>:</th>
		  <td><select id = "txtbudgetcode" name = "txtbudgetcode" onChange=""> 
		    <?php
	 ...
	 <tr>
      ...
      <script> document.getElementById('txtyear').value="<?php echo $bud_year;?>";</script>
      </td>
      </tr>
...
<option value="December">December</option>
      ...
      <tr>
       <th align="left">Budget Request Date</th>
       <th>:</th>
       ...
       <td colspan="4"><table width="100%" border="0">
         <tr>
          ...
          <td class="tbrow" width="22%"><div align="center">
            <input name="btnAdd" type="submit" id="btnAdd" value="Add" <?php if ($butOp1==false){echo 'disabled="disabled"';}?> />
           </div></td>
          <td class="tbrow" width="22%"><div align="center">
            <input name="btnEdi" type="submit" id="btnEdi" value="Edit" <?php if ($butOp2==false){echo 'disabled="disabled"';}?> />
           </div></td>
          <td class="tbrow" width="22%"><div align="center">
            <input name="btnDel" type="submit" id="btnDel" value="Delete" <?php if ($butOp3==false){echo 'disabled="disabled"';}?> />
           </div></td>
          <td class="tbrow"  width="6%">&nbsp;</td>
         </tr>
        </table>
  ...
  <table width="1429"  cellpadding="5" cellspacing="3" id="wrapped">
   <tr>
    ...
    <?php
	//$empno = $_SESSION['proclogin_un'];
    $ress=$db->Exe_Qry("SELECT * FROM bud_req_user where user= '$empno';");// WHERE user='$empno'
	while ($roww = $db->Next_Record($ress))
	    {
	        echo "<tr>
			<th>".$roww["pr_no"]."</th>
