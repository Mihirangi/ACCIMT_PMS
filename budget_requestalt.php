...
else if (isset($_POST['btnAdd']))
{
	...
	$db->Exe_Qry("INSERT INTO pc_transfer_bud 
  ...
  <table id="wrapped2" align="center" width="136%"  border="0" cellpadding="10" cellspacing="1">
   ...
   <h1>User Budget Request</h1>
      ...
      <tr>
	   ...
	   <th>:</th>
	  <td><select name="budCode" id = "budCode">
	   <?php 
	   echo'<option value="new">No Budget</option>';
	   $empno = $_SESSION['proclogin_un'];
	  ...
	  <script>
	   document.getElementById('budCode').value="<?php echo $bud_code;?>";
       </script>
	  ...
	  <td><select id = "touser" name = "touser">
		    ...
		    <?php
								...
								$values =$db->Exe_Qry("SELECT DISTINCT a.user,b.Fullname FROM pc_bud_req_user a,emp_details_tbl b WHERE a.user=b.EmpNo");
