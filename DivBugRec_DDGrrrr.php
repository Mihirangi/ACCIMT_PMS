...
$sql="SELECT * FROM bud_req_hod WHERE  bud_year='$BudYerLst' and hod='".$_SESSION['proclogin_user']."'";	
$result=$db->Exe_Qry($sql);
print "SELECT * FROM bud_req_hod WHERE  bud_year='$BudYerLst' and hod='".$_SESSION['proclogin_user']."'";	
