	...
	<table align="center">
		<tr><td width="116">Budget No</td><td width="257"><div id = "selectbud" name = "selectbud">
		  <select name = "txtcustomer_id" id = "txtcustomer_id" onchange = "document.form1.submit()" >
            ...
            <select name = "txtcustomer_id2" id = "txtcustomer_id2" onchange = "document.form1.submit()" >
		    <?php
								
								
								$values =$db->Exe_Qry("SELECT Budg_descrip FROM pc_budget_tbl");
								echo '<option>--New Budget Code--</option>';
		   ...
		   echo'</select>'; 
	  if (isset($txtcustomer_id2))
	   {?>
            <script language="javascript" type="text/javascript">
		document.getElementById("txtcustomer_id2").value="<?php echo "$valuedes";?>";
		</script>
         <?php
	   }
	   ?>
