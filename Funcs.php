		  ...
		  <tr>
		   <td><ul id="nav" class="dropdown dropdown-horizontal">
			 ...
			 <li>
			  ...
			  <li><a href="DivBugRec_DGold.php" onClick="scrollpg()" target="datafrm">Approval of DG</a></li>	
			  <li><a href="DivBugRec_DG.php" onClick="scrollpg()" target="datafrm">Approval of DG 1</a></li>			  
			  </ul>
			  
			  </li>
			 
			 
			  <li><a href="DivBudgConfirm.php" onClick="scrollpg()" target="datafrm">B.R. Confirmation</a></li>
			  <li>
			  ...
			  <ul>
			  <li><a href="fnogen.php" onClick="scrollpg()" target="datafrm">Allocate File</a></li>
			  <li><a href="Actual_date.php" onClick="scrollpg()" target="datafrm">Add Actual Date</a></li>
			  <li> <span class="dir">Appiont TEC Related</span>
				  <ul>
				  <li><a href="appoint_TEC.php" onClick="scrollpg()" target="datafrm">Appiont TEC</a></li>
				  <li><a href="approve_TEC.php" onClick="scrollpg()" target="datafrm">Approve TEC</a></li>
				  </ul></li>
			  <li><a href="re_metho.php" onClick="scrollpg()" target="datafrm">Add Procurement Method</a></li>
			  <li> <span class="dir">BID Doc. Preperation</span>
				  <ul>
				  <li><a href="ff.php" onClick="scrollpg()" target="datafrm">Add Specification</a></li>
				  <li><a href="kk.php" onClick="scrollpg()" target="datafrm">Add Letter</a></li>
				  <li><a href="dd.php" onClick="scrollpg()" target="datafrm">Approve BID Doc. by PC</a></li>
				  </ul></li>
			  <li><a href="ss.php" onClick="scrollpg()" target="datafrm">BID Preperation</a></li>
