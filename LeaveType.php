	...
	<script type="text/javascript">
		...
		function bodyload()
		{
			var ajaxRequest;  // The variable that makes Ajax possible!
				...
				ajaxRequest.open("GET", "Test3/lvtypeselectfullpge.php?", true);
		...
		function tablelist()
		{
			var ajaxRequest;  // The variable that makes Ajax possible!
				...
				ajaxRequest.open("GET", "Test3/leavetypeList.php?", true);
				ajaxRequest.send(null); 
		}
		...
		function selectr(){
			...
			if(result == "new"){
				...
				ajaxRequest.open("GET", "Test3/lvtypeselectpge.php?jj="+result, true);
				ajaxRequest.send(null); 
			}
		}
		...
		function createbtn()
		{
			...
			else
			{
				...
				ajaxRequest.open("GET", "Test3/lvtypequerypge.php?jj="+result+"&qq="+type+"&nm="+name, true);
				ajaxRequest.send(null);
			}
		}
