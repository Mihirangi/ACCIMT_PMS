...
else if (isset($_POST['btnAdd']))
{
	...
	$db->Exe_Qry("INSERT INTO transfer_bud (req_user,tra_user,bud_code_to,amount,req_date) 
	VALUES ('".$_SESSION['proclogin_un']."','$touser','$bud_coden','$amount','$req_date');");
        
        	
	$db->Exe_Qry("INSERT INTO bud_req_user(br_no,user,value,req_date,bud_year,bud_code,sub_bud_code,status) 
 ...
 <form id="form1" name="form1" method="post" action="" onSubmit="" >
  ...
  <tr>
	   ...
	   $ress = $db->Exe_Qry("SELECT br_no FROM bud_req_user");
		...
		$ress1 = $db->Exe_Qry("SELECT br_no FROM bud_req_user Where user='$_SESSION[proclogin_un]'");
    ...
    <tr>
	  ...
	  <td><select id = "touser" name = "touser">
		    ...
		    <?php
								...
								$values =$db->Exe_Qry("SELECT DISTINCT a.user,b.Fullname FROM bud_req_user a,emp_details_tbl b WHERE a.user=b.EmpNo");
