 ...
 ?>
    ...
    <td><table border="0"  align="center">
      <tr>
	   ...
	   <?php 
			...
			$pr_number =$db->Exe_Qry("SELECT b.pr_no FROM bud_req_user b,division_tbl d,emp_details_tbl e where b.user=e.EmpNo and e.DivisionCode=d.DivisionCode and d.DivisionCode='$divhod'"); // where division='$'
  ...
  <table width="1429"  cellpadding="5" cellspacing="3" id="wrapped">
   <tr>
    ...
    <?php
	$pr_number =$db->Exe_Qry("SELECT * FROM emp_details_tbl e, bud_req_user b,division_tbl d WHERE b.user=e.EmpNo and e.DivisionCode=d.DivisionCode and d.DivisionCode='$divhod' and b.recommend=''"); 
