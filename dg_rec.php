...
if (isset($_POST['butsave']))
{
	...
	$db->Exe_Qry("Update pr_dtls_tbl SET autri_dg='".$_SESSION['proclogin_un']."', autri_dg_sta='Yes', autri_dg_date='".date('Y-m-d')."' WHERE pr_no='$id1';");
...
{
	$db->Exe_Qry("UPDATE pr_dtls_tbl SET autri_dg='".$_SESSION['proclogin_un']."', autri_dg_sta='No', autri_dg_date='".date('Y-m-d')."' WHERE pr_dtls_code='$pr_dtls_code';");
...
<body onLoad="sessSet('dg_rec.php')" onClick="mytstfunc()">
<div id="wrapp">
 ...
 ?>
  ...
  <table id="wrapped2" align="center" width="95%"  border="0" cellpadding="10" cellspacing="1">
   <caption>
   <h1>DG (Director Deneral)Approvel</h1>
   </caption>
   <tr>
  ...
  <tr>
  <th>
  <h1>You are not a Director Deneral</h1>
  </th></tr></table>
  <?php
  }
  ?>
