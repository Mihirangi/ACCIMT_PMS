...
?>
    ...
    <?php
        ...
        if(isset($_POST['sup_view']))
		{
			header("Location:supplier_view.php");
		}
        
        if(isset($_POST['item_view']))
		{
			header("Location:item_view.php");
		}
...
<!--
                        <input type="submit" name="sup_view" value="View by Supplier">
                        <input type="submit" name="item_view" value="View by Item">
-->
                    </td>
                </tr>
                ...
                <tr>
					<th valign="top" scope="row"><div align="left">View by</div></th>
					<th valign="top">:</th>
