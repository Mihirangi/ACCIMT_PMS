...
-- 
-- Host: localhost
-- Generation Time: Feb 03, 2017 at 04:02 AM
...
-- 
-- Table structure for table `DDG_comment_tbl`
-- 

CREATE TABLE `DDG_comment_tbl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ddg_comment` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- 
-- Dumping data for table `DDG_comment_tbl`
-- 
...
INSERT INTO `appoint_tec` (`File_no`, `EmpNo`, `type_id`, `Approve`) VALUES ('ACC/FN/01', 188, 2, 'Y'),
('ACC/FN/02', 217, 1, ''),
('Acc/FN/03', 72, 2, '');
...
INSERT INTO `appoint_tec_type` (`type_id`, `type_des`) VALUES (1, 'Chairman'),
(2, 'employee');
...
-- 
-- Table structure for table `bud_req_hod`
-- 

CREATE TABLE `bud_req_hod` (
...
-- 
-- Dumping data for table `bud_req_hod`
-- 

INSERT INTO `bud_req_hod` (`total_id`, `bud_year`, `bud_code`, `approved`, `total`, `hod`, `appd_total`, `appd_DDG`, `appd_DG`, `DG_appdtotal`, `appd_finance`, `appd_totalfinance`) VALUES (1, 2017, 'BU/BS', 'Y', 129000, 93, 0, '', '', '', '', 0),
...
CREATE TABLE `bud_req_user` (
  ...
  `process` varchar(1) NOT NULL DEFAULT 'n',
  `amtbal` float NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=73 DEFAULT CHARSET=latin1 AUTO_INCREMENT=73 ;

-- 
-- Dumping data for table `bud_req_user`
-- 

INSERT INTO `bud_req_user` (`id`, `pr_no`, `user`, `equ_detail`, `purpose`, `similar_equ`, `reason`, `value`, `target_month`, `req_date`, `bud_year`, `bud_code`, `sub_bud_code`, `approved`, `Recommend`, `Rec_DDG`, `Rec_DG`, `value_DDG`, `value_DG`, `process`, `amtbal`) VALUES (2, 1, 5, 'Rehabilitation and Improvement of Capital Assets (ISD)', '', '', '', 200, 'September', '2017-01-03', 2017, 'BU/BS/ISD/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 200),
(4, 2, 257, 'Modification of Building "C"', '', '', '', 3000, 'June', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(5, 3, 257, 'Modification of Building "A"', '', '', '', 15000, 'June', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(6, 4, 257, 'Audio Visual System for Auditorium "A"', '', '', '', 4000, 'September', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(7, 5, 257, 'Modification of Auditorium - Building "C"', '', '', '', 2000, 'June', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(8, 6, 257, 'Vehicle Purchase under Financial Leasing Method', '', '', '', 30000, 'December', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(9, 7, 257, 'Prepare Basement of New Building', '', '', '', 200000, 'July', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(10, 8, 93, 'Infrastructure Development of ISON Project (SAD)', '', '', '', 3000, 'December', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(11, 9, 93, 'Construction of Clean Room for Nano Satellite (SAD)', '', '', '', 3000, 'December', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(12, 10, 93, 'Infrastructure Development of Satellite Ground Station (SAD)', '', '', '', 120000, 'December', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(13, 11, 93, 'Infrastructure of National Astronomical Observatory (SAD)', '', '', '', 3000, 'December', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(14, 12, 257, 'Furniture for Auditorium', '', '', '', 4000, 'June', '2017-01-03', 2017, 'BU/FF', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(15, 13, 59, 'Computer', '', '', '', 100, 'February', '2017-01-03', 2017, 'BU/CO/ADH/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(16, 14, 59, 'RFID / ID Card Colour Printer', '', '', '', 450, 'January', '2017-01-03', 2017, 'BU/CO/ADH/17/2', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(17, 15, 285, 'Computers', '', '', '', 50, 'July', '2017-01-03', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(18, 16, 285, 'Office Equipment', '', '', '', 25, 'August', '2017-01-03', 2017, 'BU/OE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(19, 17, 285, 'Furniture & Fittings', '', '', '', 25, 'August', '2017-01-03', 2017, 'BU/FF', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(21, 18, 192, 'Books - Part 01', '', '', '', 30, 'January', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(22, 19, 192, 'Books - Part 02', '', '', '', 30, 'February', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(23, 20, 192, 'Books - Part 03', '', '', '', 30, 'March', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(24, 21, 192, 'Books - Part 04', '', '', '', 30, 'April', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(25, 22, 192, 'Books - Part 05', '', '', '', 40, 'May', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(26, 23, 192, 'Books - Part 06', '', '', '', 40, 'June', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(27, 24, 192, 'Books - Part 07', '', '', '', 50, 'July', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(28, 25, 192, 'Books - Part 08', '', '', '', 50, 'August', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(29, 26, 192, 'Books - Part 09', '', '', '', 50, 'September', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(30, 27, 192, 'Books - Part 10', '', '', '', 50, 'October', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(31, 28, 192, 'Books - Part 11', '', '', '', 50, 'November', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(32, 29, 192, 'Books - Part 12', '', '', '', 50, 'December', '2017-01-03', 2017, 'BU/LB', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(33, 30, 192, '02 Nos. Computers for Computer Room', '', '', '', 250, 'March', '2017-01-03', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(34, 31, 192, 'WiFi Router', '', '', '', 20, 'February', '2017-01-03', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(35, 32, 149, 'PCs/Accessories/Peripherals', '', '', '', 150, 'July', '2017-01-03', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(36, 33, 149, 'Office Equipment', '', '', '', 300, 'July', '2017-01-03', 2017, 'BU/OE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(37, 34, 149, 'Lab Equipment', '', '', '', 3000, 'July', '2017-01-03', 2017, 'New', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(38, 35, 120, 'RF Radiation Testing Facility', '', '', '', 3000, 'April', '2017-01-03', 2017, 'BU/OE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(39, 36, 120, 'Computers & Related Peripherals', '', '', '', 500, 'March', '2017-01-03', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(40, 37, 120, 'Development Tools (Mechatronics & Embedded Systems) ', '', '', '', 2000, 'May', '2017-01-03', 2017, 'BU/LE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(41, 38, 120, 'Laboratary Repair & Upgrading', '', '', '', 500, 'January', '2017-01-03', 2017, 'BU/BS', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(42, 39, 120, 'RF Equipment Calibration ', '', '', '', 1000, 'February', '2017-01-03', 2017, 'BU/LE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(43, 40, 93, 'Satellite Ground Station Equipment', '', '', '', 10000, 'December', '2017-01-04', 2017, 'BU/LE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(44, 41, 93, 'UAV Photogrammetry Software', '', '', '', 1800, 'December', '2017-01-04', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(45, 42, 93, 'GNSS Surveying System', '', '', '', 2500, 'December', '2017-01-04', 2017, 'BU/LE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(46, 43, 93, 'Workstation Computer', '', '', '', 4000, 'December', '2017-01-04', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(47, 44, 93, 'Design & Analysis Software', '', '', '', 5000, 'December', '2017-01-04', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(48, 45, 93, 'Nano Satellite Project Equipment ', '', '', '', 50000, 'December', '2017-01-04', 2017, 'BU/LE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(49, 46, 93, 'Furniture - Executive Tables & Chairs', '', '', '', 300, 'December', '2017-01-04', 2017, 'BU/FF', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(50, 47, 93, 'Diffraction Grating', '', '', '', 400, 'December', '2017-01-04', 2017, 'BU/LE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(51, 48, 93, 'Optical Filters', '', '', '', 300, 'December', '2017-01-04', 2017, 'BU/LE', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(52, 49, 190, 'Computers & Accessories', '', '', '', 1800, 'March', '2017-01-04', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(53, 50, 190, 'Project Based Equipment', '', '', '', 150, 'June', '2017-01-04', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(54, 51, 190, 'Internal Network Maintenance', '', '', '', 250, 'January', '2017-01-04', 2017, 'BU/CO', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(55, 52, 5, 'Test & Measuring Equipment and Accessories - Lamp Rack', '', '', '', 1000, 'August', '2017-01-04', 2017, 'BU/LE/ISD/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 1000),
(56, 53, 5, 'Computer', '', '', '', 200, 'August', '2017-01-04', 2017, 'BU/CO/ISD/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(57, 54, 5, 'Printer', '', '', '', 100, 'July', '2017-01-04', 2017, 'BU/CO/ISD/17/2', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(59, 55, 215, 'Computer Table & Chair', '', '', '', 25, 'February', '2017-01-04', 2017, 'BU/FF', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(61, 56, 180, 'Capacity Building', '', '', '', 2100, 'December', '2017-01-04', 2017, 'BU/AP/TTD/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(62, 57, 120, 'HR Capacity Development', '', '', '', 1000, 'May', '2017-01-04', 2017, 'BU/AP/COM/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(63, 58, 149, 'Capacity Building though Foriegn Collaboration (In the area of test and measurement service ', '', '', '', 1000, 'December', '2017-01-04', 2017, 'BU/AP/ELE/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(65, 59, 190, 'Human Resource Development', '', '', '', 1000, 'January', '2017-01-04', 2017, 'BU/AP/ITD/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(66, 60, 5, 'Foreign Training for LMS/Calibration project with foreign collaboration/Funds', '', '', '', 1000, 'December', '2017-01-04', 2017, 'BU/AP/ISD/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(68, 61, 93, 'Capacity Building Programs - Workshop & Consultancy in Space Technology Applications', '', '', '', 1000, 'December', '2017-01-04', 2017, 'BU/AP/SAD/17/1', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(69, 62, 93, 'Capacity Building Programes in Space Technology', '', '', '', 4755, 'December', '2017-01-04', 2017, 'BU/AP/SAD/17/2', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(70, 63, 93, 'Nano Satellite Project Training Programes', '', '', '', 0, 'December', '2017-01-04', 2017, 'BU/AP/SAD/17/3', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(71, 64, 93, 'Capacity Building Programs - Astronomy Teacher Training Program', '', '', '', 200, 'December', '2017-01-04', 2017, 'BU/AP/SAD/17/4', '', 'Y', 'Y', '', '', 0, 0, 'n', 0),
(72, 65, 93, 'Capacity Building Programs - Water Rocket making workshop & competition', '', '', '', 50, 'December', '2017-01-04', 2017, 'BU/AP/SAD/17/5', '', 'Y', 'Y', '', '', 0, 0, 'n', 0);
...
INSERT INTO `bud_req_user_old` (`id`, `pr_no`, `user`, `equ_detail`, `purpose`, `similar_equ`, `reason`, `value`, `target_month`, `req_date`, `bud_year`, `bud_code`, `approved`) VALUES (40, 4, 93, 'ww', '   jjj ', '77', 'bhh', 0, '0', '2016-11-09', 2016, '20', 'N'),
...
INSERT INTO `budget_tbl` (`budg_no`, `Budg_descrip`, `budg_code`, `short_descrip`) VALUES (1, 'Computers & Softwares', 'BU/CO', 'CO'),
...
INSERT INTO `category_tbl` (`CategoryCode`, `Category`, `InTime`, `OutTimeH`, `OutTimeM`, `AdjestTime`, `LateTime`) VALUES (1, 'Staff', '08:30:00', 7, 45, '08:45:00', '09:30:00'),
(2, 'Middle', '08:30:00', 7, 45, '08:45:00', '09:00:00'),
(3, 'Minor', '08:00:00', 8, 45, '08:15:00', '08:30:00'),
(4, 'Unset', '00:00:00', 0, 0, '00:00:00', '00:00:00');
...
INSERT INTO `div_budg_tbl` (`divb_code`, `div_code`, `budg_code`, `budg_year`, `user_descrip`, `req_amount`, `appr_amount`, `req_confirm`, `app_confirm`, `the_amount`) VALUES (30, 9, 'BU/CO/IT/16', 2016, 'Computers and accessories', 1050000, 1000, 'Y', 'Y', 1000),
...
(53, 'Mrs', 'W. B. A. Weerawarnasuriya', '548330696V', '1954-11-28', 'Female', '', '', '1991-02-21', 11, 48, 2, 1, '2014-11-27'),
(59, 'Mrs.', 'G. H. C. Jayarani', '675020450V', '1967-03-03', 'Female', '', '', '1991-11-06', 11, 1000, 2, 1, '2027-03-02'),
...
(143, 'Mrs.', 'N P Ketipearachchi', '695731400 ', '1969-03-13', 'Female', 'nilmini@accmt.ac.lk', '', '1999-10-01', 11, 98, 2, 2, '2029-03-12'),
...
(209, 'Mr', 'W. C. B.  De Silva', '740480413V', '1974-02-17', 'Male', 'chamika@accmt.ac.lk', '', '2006-02-03', 11, 1001, 2, 2, '2034-02-16'),
...
(265, 'Mr.', 'P. Chandima Ramanayake', '880931890V', '1988-04-02', 'Male', '', '', '2013-10-03', 11, 99, 2, 3, '2048-04-01'),
...
(290, 'Ms.', 'R.M.S.D. Madumala', '907701085V', '1990-09-26', 'Male', '', '', '2014-11-03', 11, 1001, 2, 2, '2050-09-25'),
(291, 'Ms.', 'W.A. Pavithra Madushani', '918440925V', '1991-12-09', 'Male', '', '', '2014-11-03', 11, 1001, 2, 2, '2051-12-08'),
...
(90207, 'Ms.', 'K D D R GUNATHILAKA', '', '2015-01-01', 'Female', '', '', '2014-03-03', 11, 999, 3, 2, NULL),
...
(8, 'Mr', 'P. Thilakasiri', '', '0000-00-00', 'Male', '', '', '0000-00-00', 11, 76, 0, 0, '2014-11-30'),
...
(53, 'Mrs', 'W. B. A. Weerawarnasuriya', '548330696V', '0000-00-00', 'Female', '', '', '0000-00-00', 11, 48, 0, 0, '2014-11-30'),
(59, 'Mrs.', 'G. H. C. Jayarani', '', '0000-00-00', 'Female', '', '', '0000-00-00', 11, 40, 0, 0, '2014-11-30'),
...
(143, 'Mrs.', 'N P Ketipearachchi', '695731400 ', '0000-00-00', 'Female', 'nilmini@accmt.ac.lk', '', '0000-00-00', 11, 98, 0, 0, '2014-11-30'),
...
(209, 'Mr', 'W. C. B.  De Silva', '740480413V', '0000-00-00', 'Male', 'chamika@accmt.ac.lk', '', '0000-00-00', 11, 112, 0, 0, '2014-11-30'),
...
INSERT INTO `emp_type_tbl` (`EmpTypeCode`, `EmpType`) VALUES (1, 'Casual'),
(2, 'Permenent'),
(3, 'Trainee'),
(4, 'Security'),
(5, 'unset');
...
INSERT INTO `file_tbl` (`file_no`, `file_date`, `pro_id`) VALUES ('ACC/FN/02', '2015-10-01', 1),
...
INSERT INTO `ibudg_alloc_tbl` (`item_allo_no`, `pr_no`, `M_Pr_No`, `serial_no`, `divb_code`, `item_no`, `alloc_amt`, `act_amt`, `pr_date`, `act_date`, `div_approval`) VALUES (1, '0', 0, 1, 46, 0, 34234, 0, '2016-09-26', '0000-00-00', 0),
...
INSERT INTO `item_dtls_tbl` (`divb_code`, `item_no`, `description`, `target_month`, `item_amount`, `active`) VALUES (1, 1, 'Laptop Compuetr', 'January', 200000, 1),
...
INSERT INTO `login_tbl_leave` (`Emp_No`, `Designation`, `Division`, `category`, `Password`, `Emp_Type`) VALUES (1, '', '', '', '698d51a19d8a121ce581499d7b701668', 'ADM'),
...
INSERT INTO `lv_type_tbl` (`Leave_Type_ID`, `Leave_Type`) VALUES (1, 'Medical'),
(2, 'Vacation'),
(3, 'Casual'),
(4, 'Lapse'),
(5, 'Duty'),
...
INSERT INTO `pr_deny` (`pr_no`, `reason`) VALUES (1, ''),
(19, '');
...
INSERT INTO `pr_type` (`pr_type_no`, `description`, `short_name`) VALUES (1, 'Works', 'W'),
(2, 'Goods', 'G'),
(3, 'Services', 'S');
...
CREATE TABLE `procurement_method_tbl` (
...
INSERT INTO `procurement_method_tbl` (`pro_id`, `description`) VALUES (1, 'National Competitive Bidding (NCB)'),
...
INSERT INTO `rem_lv_tbl` (`Leave_ID`, `Emp_No`, `Appr_Type`, `Remarks`) VALUES (30, 213, 'S', ''),
(32, 24, 'A', '');
...
INSERT INTO `shdl_task_tbl` (`sh_no`, `sh_des`, `date_range`) VALUES (1, 'Appoint TEC', 3),
(2, 'App.spec by TEC', 3),
...
INSERT INTO `usage_dtls_tbl` (`usage_no`, `usg_descrip`, `usage_nm`) VALUES (1, 'Normal office works', 'Normal'),
