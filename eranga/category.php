	...
	?>
			<?php		
				if(isset($_POST['btnadd'])){
					...
					if (empty($_POST["categoryname"])){
						...
						if(mysql_num_rows($result)==0){
								...
								$query2 = "Insert category_tbl(Category,InTime,OutTimeH,OutTimeM,AdjustTime,LateTime) Values(	'". $category . "',". "'" . $intime . "',"."'". $workH . "',"."'".$workM."',"."'".$adjusttime."',"."'".$latetime."');";
				...
				if(isset($_POST['btnedit'])){ // Fetching variables of the form which travels in URL
					...
					$query = mysql_query("Update category_tbl Set Category='$category',InTime='$intime',OutTimeH='$workH',OutTimeM='$workM',AdjustTime='$adjusttime',LateTime='$latetime' WHERE CategoryCode='$row[0]'");
				}
		...
		<table align="center" width="95%" id="wrapped2"  border="0" cellpadding="10" cellspacing="1">
			...
			<tr>
				...
				<tr>
					...
					<td class=""><?php echo $myrow['AdjustTime']; ?></td> 
